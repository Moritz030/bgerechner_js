...
calculateBtn.addEventListener('click', () => {
  ...
  mitmachen.innerHTML= '<div style="margin-top:48px;"><p><a class="link-light" style="padding:4px 16px 4px 16px; border-radius:8px; background-color: rgb(116,4,4);" href="https://www.mit-links-zum-grundeinkommen.de/">Mitgliederentscheid</a></p></div>';
});
